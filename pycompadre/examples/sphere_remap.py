...
class TestSphereRemap(KokkosTestCase):
    ...
    def test_edge_integrated_remap(self):
        ...
        print('computed out:',out_field)
        print('exact out:',exact_out_field)
        #print('diff_0:',out_field[:,0] - exact_out_field[:,0])
        #print('diff_1:',out_field[:,1] - exact_out_field[:,1])
        #print('diff_2:',out_field[:,2] - exact_out_field[:,2])
        #print(dataset['latEdge'][:])
        #print(dataset['lonEdge'][:])
        print('diff:',out_field - exact_out_field)
