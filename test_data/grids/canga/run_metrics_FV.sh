...
python $METRICS_FOLDER/CANGAMetricsDriver.py --ss $METRICS_FOLDER/ICOD/sample_NM16_O10_ICOD-r64_TPW_CFR_TPO_A1_A2.nc --st $METRICS_FOLDER/RLL/sample_NM16_O10_RLL-r180-360_TPW_CFR_TPO_A1_A2.nc --smc 1 --tmc 1 --field $FIELDNAME  --data $DATA_FOLDER/ICOD_64.g-RLL_180-360.g --dimension $DIM --output $DATA_FOLDER/out_2.csv >> $DATA_FOLDER/out.txt &
...
#python $METRICS_FOLDER/CANGAMetricsDriver.py --includeGradientMetrics --ss $METRICS_FOLDER/CS/sample_NM16_O10_CS-r16_TPW_CFR_TPO_A1_A2.nc --st $METRICS_FOLDER/ICOD/sample_NM16_O10_ICOD-r16_TPW_CFR_TPO_A1_A2.nc --smc 1 --tmc 1 --field $FIELDNAME  --data $DATA_FOLDER/CS_16.g-ICOD_16.g --dimension $DIM --output $DATA_FOLDER/out_0.csv > $DATA_FOLDER/out.txt &
#python $METRICS_FOLDER/CANGAMetricsDriver.py --includeGradientMetrics --ss $METRICS_FOLDER/CS/sample_NM16_O10_CS-r32_TPW_CFR_TPO_A1_A2.nc --st $METRICS_FOLDER/ICOD/sample_NM16_O10_ICOD-r32_TPW_CFR_TPO_A1_A2.nc --smc 1 --tmc 1 --field $FIELDNAME  --data $DATA_FOLDER/CS_32.g-ICOD_32.g --dimension $DIM --output $DATA_FOLDER/out_1.csv >> $DATA_FOLDER/out.txt &
#python $METRICS_FOLDER/CANGAMetricsDriver.py --includeGradientMetrics --ss $METRICS_FOLDER/CS/sample_NM16_O10_CS-r64_TPW_CFR_TPO_A1_A2.nc --st $METRICS_FOLDER/ICOD/sample_NM16_O10_ICOD-r64_TPW_CFR_TPO_A1_A2.nc --smc 1 --tmc 1 --field $FIELDNAME  --data $DATA_FOLDER/CS_64.g-ICOD_64.g --dimension $DIM --output $DATA_FOLDER/out_2.csv >> $DATA_FOLDER/out.txt &
