...
METRICS_FOLDER=/ascldap/users/pakuber/Compadre/compadre/test_data/grids/canga/metrics_RRM
...
declare -a cs_f_arr=("CS-r32" "CS-r64" "CS-r128" "CS-r256")
declare -a icod_f_arr=("ICOD-r32" "ICOD-r64" "ICOD-r128" "ICOD-r256")

declare -a rll_c_arr=("RLL_30-60" "RLL_90-180" "RLL_180-360" "RLL_360-720" "RLL_720-1440")
declare -a cs_c_arr=("RRM_CS_32" "RRM_CS_64" "RRM_CS_128" "RRM_CS_256")
declare -a icod_c_arr=("RRM_ICOD_32" "RRM_ICOD_64" "RRM_ICOD_128" "RRM_ICOD_256")

declare -a rll_a_arr=("RLL16" "RLL32" "RLL64" "RLL128" "RLL256")
declare -a cs_a_arr=("CS32" "CS64" "CS128" "CS256")
declare -a icod_a_arr=("ICOD32" "ICOD64" "ICOD128" "ICOD256")

OUTPUT_ROOT_FOLDER=/ascldap/users/pakuber/Compadre/compadre/test_data/grids/canga/output_RRM

PROCS=8

function call_metrics(){
for k in {4..4}; 
do DATA_FOLDER=/gpfs1/pakuber/CANGA/RRM_${TYPE_1_NAME}_${TYPE_2_NAME}/$P_PRE$k OUTPUT_FOLDER=$OUTPUT_BASE_FOLDER/${POST_NAME}; 
    for i in {0..2}; 
        do for j in {0..2}; 
        do echo "python $METRICS_FOLDER/CANGAMetricsDriver.py --includeGradientMetrics --ss $METRICS_FOLDER/RRM_$TYPE_1_NAME/sample_NM32_O18_${TYPE_1_F[$i]}_TPW_CFR_TPO_A1_A2.nc --st $METRICS_FOLDER/RRM_$TYPE_2_NAME/sample_NM32_O18_${TYPE_2_F[$j]}_TPW_CFR_TPO_A1_A2.nc --smc 1 --tmc 4 --field $FIELDNAMES  --data $DATA_FOLDER/${TYPE_1_C[$i]}.g-${TYPE_2_C[$j]}.g --processes $PROCS --dimension $DIM --output $OUTPUT_FOLDER/metrics_${TYPE_1_A[$i]}_${TYPE_2_A[$j]}_O$((k+1)).csv > $OUTPUT_FOLDER/out_${POST_NAME}_${TYPE_1_A[$i]}_${TYPE_2_A[$j]}_p$k.txt"; 
                python $METRICS_FOLDER/CANGAMetricsDriver.py --includeGradientMetrics --ss $METRICS_FOLDER/RRM_$TYPE_1_NAME/sample_NM32_O18_${TYPE_1_F[$i]}_TPW_CFR_TPO_A1_A2.nc --st $METRICS_FOLDER/RRM_$TYPE_2_NAME/sample_NM32_O18_${TYPE_2_F[$j]}_TPW_CFR_TPO_A1_A2.nc --smc 1 --tmc 4 --field $FIELDNAMES  --data $DATA_FOLDER/${TYPE_1_C[$i]}.g-${TYPE_2_C[$j]}.g --processes $PROCS --dimension $DIM --output $OUTPUT_FOLDER/metrics_${TYPE_1_A[$i]}_${TYPE_2_A[$j]}_O$((k+1)).csv > $OUTPUT_FOLDER/out_${POST_NAME}_${TYPE_1_A[$i]}_${TYPE_2_A[$j]}_p$k.txt; 
                #python $METRICS_FOLDER/CANGAMetricsDriver.py --includeGradientMetrics --ss $METRICS_FOLDER/$TYPE_1_NAME/sample_NM32_O18_${TYPE_1_F[$i]}_TPW_CFR_TPO_A1_A2.nc --st $METRICS_FOLDER/$TYPE_2_NAME/sample_NM32_O18_${TYPE_2_F[$j]}_TPW_CFR_TPO_A1_A2.nc --smc 1 --tmc 1 --field $FIELDNAMES  --data $DATA_FOLDER/${TYPE_1_C[$i]}.g-${TYPE_2_C[$j]}.g --processes $PROCS --dimension $DIM --output $OUTPUT_FOLDER/metrics_${TYPE_1_A[$i]}_${TYPE_2_A[$j]}_O$((k+1)).csv > $OUTPUT_FOLDER/out_${POST_NAME}_${TYPE_1_A[$i]}_${TYPE_2_A[$j]}_p$k.txt; 
        done; 
    done; 
done;
}
