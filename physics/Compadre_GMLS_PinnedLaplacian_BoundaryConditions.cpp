...
void GMLS_PinnedLaplacianBoundaryConditions::flagBoundaries() {
	auto pts = this->_coords->getPts()->getLocalViewDevice(Tpetra::Access::OverwriteAll);
...
std::vector<InteractingFields> GMLS_PinnedLaplacianBoundaryConditions::gatherFieldInteractions() {
