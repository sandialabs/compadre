...
void GMLS_PinnedLaplacianNeumannBoundaryConditions::flagBoundaries() {
}

void GMLS_PinnedLaplacianNeumannBoundaryConditions::applyBoundaries(local_index_type field_one, local_index_type field_two, scalar_type time) {
