#ifndef _COMPADRE_GMLS_CURLCURLPHYSICS_HPP_
#define _COMPADRE_GMLS_CURLCURLPHYSICS_HPP_
...
class GMLS_CurlCurlPhysics : public PhysicsT {
	...
	public:
		GMLS_CurlCurlPhysics(Teuchos::RCP<particle_type> particles, local_index_type t_Porder,
