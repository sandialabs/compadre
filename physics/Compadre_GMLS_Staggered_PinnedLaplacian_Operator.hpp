#ifndef _COMPADRE_GMLS_STAGGERED_PINNEDLAPLACIANPHYSICS_HPP_
#define _COMPADRE_GMLS_STAGGERED_PINNEDLAPLACIANPHYSICS_HPP_
...
class GMLS_Staggered_LaplacianPhysics : public PhysicsT {
	...
	public:
		GMLS_Staggered_LaplacianPhysics(Teuchos::RCP<particle_type> particles, local_index_type t_Porder,
		...
		virtual ~GMLS_Staggered_LaplacianPhysics() {}
