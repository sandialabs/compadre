#ifndef _COMPADRE_GMLS_POISSONNEUMANNPHYSICS_HPP_
#define _COMPADRE_GMLS_POISSONNEUMANNPHYSICS_HPP_
...
class GMLS_PoissonNeumannPhysics : public PhysicsT{
    protected:
    ...
    public:
        ...
        GMLS_PoissonNeumannPhysics(Teuchos::RCP<particle_type> particles, local_index_type t_Porder,
        ...
        virtual ~GMLS_PoissonNeumannPhysics() {}
