...
// otherwise, Views may be deallocating when we call Kokkos::finalize() later
{
    ...
    // The remap class takes care of handling input data views as well as the output data views.
    ...
    Remap vector_remap_manager_of_scalar_clones(&my_GMLS_vector_of_scalar_clones);
