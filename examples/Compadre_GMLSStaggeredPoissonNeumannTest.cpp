...
#include <Compadre_GMLS_Staggered_PoissonNeumann_Sources.hpp>
...

    {
        ...
        for (LO i=0; i<parameters->get<int>("loop size"); i++) {
            ...
            ST halo_size;
            {
                ...
                Teuchos::RCP<Compadre::GMLS_Staggered_PoissonNeumannPhysics> physics =
                    Teuchos::rcp( new Compadre::GMLS_Staggered_PoissonNeumannPhysics(particles, Porder));
                Teuchos::RCP<Compadre::GMLS_Staggered_PoissonNeumannSources> source =
                    Teuchos::rcp( new Compadre::GMLS_Staggered_PoissonNeumannSources(particles));
