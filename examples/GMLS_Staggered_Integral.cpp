...
// otherwise, Views may be deallocating when we call Kokkos::finalize() later
{
    ...
    // ensure that source coordinates are sent to device before evaluating sampling data
    Kokkos::fence();
    ...
    //
    my_GMLS.setProblemData(neighbor_lists_device,
                           source_coords_device,
    ...
    // How the input data is transformed
