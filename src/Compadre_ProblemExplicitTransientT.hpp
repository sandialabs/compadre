#ifndef _COMPADRE_PROBLEM_EXPLICIT_TRANSIENT_HPP_
#define _COMPADRE_PROBLEM_EXPLICIT_TRANSIENT_HPP_
...
*/
class ProblemExplicitTransientT {
...
//		std::vector<std::vector<Teuchos::RCP<crs_matrix_type> > > _A;
	...
	public:
		...
		ProblemExplicitTransientT(	Teuchos::RCP<particle_type> particles,
		...
		virtual ~ProblemExplicitTransientT() {};
