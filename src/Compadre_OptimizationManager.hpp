...
struct OptimizationObject {
    ...
    bool _local_bounds_preservation;
    bool _global_bounds_preservation;
    ...
    OptimizationObject(OptimizationAlgorithm optimization_algorithm = NONE, bool single_linear_bound_constraint = true,
            bool local_bounds_preservation = true, scalar_type global_lower_bound = std::numeric_limits<scalar_type>::lowest(), 
        ...
        _local_bounds_preservation(local_bounds_preservation), 
        _global_bounds_preservation(false), 
        _global_lower_bound(global_lower_bound), 
