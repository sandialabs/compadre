...
class PointCloudSearch {
    ...
    public:
        ...
        //void generateKDTree() {
            ...
            //    //_tree_1d->buildIndex();
            //    _tree_1d = std::make_shared<BVH>();//(1, *this, nanoflann::KDTreeSingleIndexAdaptorParams(_max_leaf));
            //} else if (_dim==2) {
            //    _tree_2d = std::make_shared<BVH>();//std::make_shared<tree_type_2d>(2, *this, nanoflann::KDTreeSingleIndexAdaptorParams(_max_leaf));
            //    _tree_2d->buildIndex();
            //} else if (_dim==3) {
            //    _tree_3d = std::make_shared<BVH>();//std::make_shared<tree_type_3d>(3, *this, nanoflann::KDTreeSingleIndexAdaptorParams(_max_leaf));
            //    //_tree_3d->buildIndex();
            //}
        //}
