...
namespace GMLS_LinearAlgebra {
    ...
    */
    ...
    /*! \brief Solves a batch of QR+Pivoting problems
        ...
        Note: RHS is intended to store entries from a diagonal matrix (as a vector). I.e., for the kth matrix, the (m,m) entry of a diagonal matrix would here be stored in the mth position.
