#ifndef _COMPADRE_POINTCLOUDSEARCH2_HPP_
#define _COMPADRE_POINTCLOUDSEARCH2_HPP_
...
void PointCloudSearch2<view_type>::generate2DNeighborListsFromRadiusSearch(trg_view_type trg_pts_view,
...
template <typename view_type>
template <typename trg_view_type, typename neighbor_lists_view_type, typename epsilons_view_type>
void PointCloudSearch2<view_type>::generate2DNeighborListsFromKNNSearch(trg_view_type trg_pts_view,
        neighbor_lists_view_type& neighbor_lists, epsilons_view_type& epsilons,
...
//! CreatePointCloudSearch2 allows for the construction of an object of type PointCloudSearch2 with template deduction
template <typename view_type>
PointCloudSearch2<view_type> CreatePointCloudSearch2(view_type src_view, const local_index_type dimensions = -1, const local_index_type max_leaf = -1) { 
    return PointCloudSearch2<view_type>(src_view, dimensions, max_leaf);
}
