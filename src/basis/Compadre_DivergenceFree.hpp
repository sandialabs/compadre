...
ports up to 4th-order polynomials for now.");
    ...
    // Calculating the basis functions
    KOKKOS_INLINE_FUNCTION
    XYZ calcGradientDivFreeBasis(int np, const int partial_direction, const double sx, const double sy, const double sz) {
        // define one-third
        const double th = 1./3.;
...
ports up     to 4th-order polynomials for now.");
    ...
    KOKKOS_INLINE_FUNCTION
    XYZ calcGradientDivFreeBasis(int np, const int partial_direction, const double sx, const double sy) {
        // define one-third
        ...
        if (partial_direction==0) {
            switch (np) {
                ...
                case 3: return XYZ( 0,  1, 0);
                case 4: return XYZ( 0,  0, 0);

                // P2
                case 5: return XYZ(          0,          0, 0);
                case 6: return XYZ(          0,       2*sx, 0);

                case 7: return XYZ(       2*sx,    -2.0*sy, 0);
                case 8: return XYZ(    -2.0*sy,          0, 0);

                // P3
                case 9 : return XYZ(            0,             0, 0);
                case 10: return XYZ(            0,       3*sx*sx, 0);

                case 11: return XYZ(      3*sx*sx,    -6.0*sx*sy, 0);
                case 12: return XYZ(    2.0*sx*sy,    -1.0*sy*sy, 0);
                case 13: return XYZ(   -3.0*sy*sy,             0, 0);

                // P4
                case 14: return XYZ(               0,                0, 0);
                case 15: return XYZ(               0,       4*sx*sx*sx, 0);

                case 16: return XYZ(      4*sx*sx*sx,   -12.0*sx*sx*sy, 0);
                case 17: return XYZ(    6.0*sx*sx*sy,    -6.0*sx*sy*sy, 0);
                case 18: return XYZ(   -6.0*sx*sy*sy,     2.0*sy*sy*sy, 0);
                case 19: return XYZ(   -4.0*sy*sy*sy,                0, 0);
...
ports up     to 4th-order polynomials for now.");
            ...
            switch (np) {
                ...
                // P1
                case 2: return XYZ( 1,  0, 0);
                case 3: return XYZ( 0,  0, 0);
                case 4: return XYZ( 0, -1, 0);

                // P2
                case 5: return XYZ(       2*sy,          0, 0);
                case 6: return XYZ(          0,          0, 0);

                case 7: return XYZ(          0,    -2.0*sx, 0);
                case 8: return XYZ(    -2.0*sx,       2*sy, 0);

                // P3
                case 9 : return XYZ(      3*sy*sy,             0, 0);
                case 10: return XYZ(            0,             0, 0);

                case 11: return XYZ(            0,    -3.0*sx*sx, 0);
                case 12: return XYZ(        sx*sx,    -2.0*sx*sy, 0);
                case 13: return XYZ(   -6.0*sx*sy,       3*sy*sy, 0);

                // P4
                case 14: return XYZ(      4*sy*sy*sy,                0, 0);
                case 15: return XYZ(               0,                0, 0);

                case 16: return XYZ(               0,    -4.0*sx*sx*sx, 0);
                case 17: return XYZ(    2.0*sx*sx*sx,    -6.0*sx*sx*sy, 0);
                case 18: return XYZ(   -6.0*sx*sx*sy,     6.0*sx*sy*sy, 0);
                case 19: return XYZ(  -12.0*sx*sy*sy,       4*sy*sy*sy, 0);
