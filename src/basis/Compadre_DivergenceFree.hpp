...
namespace Compadre {
    ...
    XYZ calcDivFreeBasis(int np, const double sx, const double sy, const double sz) {
        // define one-third
        const double th = 1./3.;
...
ports up to 4th-order polynomials for now.");
    ...
    KOKKOS_INLINE_FUNCTION
    XYZ calcDivFreeBasis(int np, const double sx, const double sy) {
        // define one-third
...
ports up to 4th-order polynomials for now.");
    ...
    // Calculating the basis functions
    KOKKOS_INLINE_FUNCTION
    XYZ calcGradientDivFreeBasis(int np, const int partial_direction, const double h, const double sx, const double sy, const double sz) {
        // define one-third
        const double th = 1./3.;
...
ports up     to 4th-order polynomials for now.");
    ...
    KOKKOS_INLINE_FUNCTION
    XYZ calcGradientDivFreeBasis(int np, const int partial_direction, const double h, const double sx, const double sy) {
        // define one-third
...
ports up     to 4th-order polynomials for now.");
    ...
    // Calculating the basis functions
    KOKKOS_INLINE_FUNCTION
    XYZ calcHessianDivFreeBasis(int np, const int partial_direction_1, const int partial_direction_2, const double h, const double sx, const double sy, const double sz) {
        // define one-third
        const double th = 1./3.;

        if (partial_direction_1==0 && partial_direction_2==0) {
            switch (np) {
                // P0
                case 0: return XYZ(0.0,0.0,0.0);
                case 1: return XYZ(0.0,0.0,0.0);
                ...
                case 12: return XYZ(         0,          0,         0);
                case 13: return XYZ(         0,          0,         0);
                case 14: return XYZ(         0,      2/h/h,         0);
                case 15: return XYZ(         0,          0,         0);
                case 16: return XYZ(         0,          0,         0);
                case 17: return XYZ(         0,          0,     2/h/h);
                case 18: return XYZ(         0,          0,         0);
                case 19: return XYZ(         0,          0,         0);

                case 20: return XYZ(     2/h/h,          0,         0);
                case 21: return XYZ(         0,          0,         0);
                case 22: return XYZ(         0,          0,         0);
                case 23: return XYZ(         0,          0,         0);
                case 24: return XYZ(         0,          0,         0);
                case 25: return XYZ(         0,          0,         0);
                ...
                case 28: return XYZ(          0,            0,             0);
                case 29: return XYZ(          0,            0,             0);
                case 30: return XYZ(          0,     6*sx/h/h,             0);
                case 31: return XYZ(          0,     2*sz/h/h,             0);
                case 32: return XYZ(          0,            0,             0);
                case 33: return XYZ(          0,            0,             0);
                case 34: return XYZ(          0,            0,      6*sx/h/h);
                case 35: return XYZ(          0,            0,      2*sy/h/h);
                case 36: return XYZ(          0,            0,             0);
                case 37: return XYZ(          0,            0,             0);

                case 38: return XYZ(   6*sx/h/h,  -6.0*sy/h/h,            0);
                case 39: return XYZ(   6*sx/h/h,            0,  -6.0*sz/h/h);
                case 40: return XYZ(   2*sy/h/h,            0,            0);
                case 41: return XYZ(   2*sy/h/h,            0,            0);
                case 42: return XYZ(   2*sz/h/h,            0,            0);
                case 43: return XYZ(   2*sz/h/h,            0,            0);
                case 44: return XYZ(          0,            0,            0);
                case 45: return XYZ(          0,            0,            0);
                case 46: return XYZ(          0,            0,            0);
                case 47: return XYZ(          0,            0,            0);
                case 48: return XYZ(          0,            0,            0);
                case 49: return XYZ(          0,            0,            0);
...
ports up     to 4th-order polynomials for now.");
        ...
        } else if (partial_direction_1==0 && partial_direction_2==1) {
            switch (np) {
                // P0
                case 0: return XYZ(0.0,0.0,0.0);
                case 1: return XYZ(0.0,0.0,0.0);
...
ports up     to 4th-order polynomials for now.");
        ...
        } else if (partial_direction_1==0 && partial_direction_2==2) {
            switch (np) {
                // P0
                case 0: return XYZ(0.0,0.0,0.0);
                case 1: return XYZ(0.0,0.0,0.0);
...
ports up     to 4th-order polynomials for now.");
        ...
        } else if (partial_direction_1==1 && partial_direction_2==1) {
            switch (np) {
                // P0
                case 0: return XYZ(0.0,0.0,0.0);
                case 1: return XYZ(0.0,0.0,0.0);
...
ports up     to 4th-order polynomials for now.");
        ...
        } else if (partial_direction_1==2 && partial_direction_2==2) {
            switch (np) {
                // P0
                case 0: return XYZ(0.0,0.0,0.0);
                case 1: return XYZ(0.0,0.0,0.0);
